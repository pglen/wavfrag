...
class CxProgCtrl : public CStatic
{
// Construction
public:

	int		volume;		// Set this to true for color volume control


	CxProgCtrl(int nNumSteps = 10, int nCurPos = 0);
	virtual ~CxProgCtrl();
	...
	void				SetCurPos(int nCurPos);						// Moved to code
